                     ...
                     children: [
                       Positioned(
                         top: _height*0.04,
                           ...
                           child: Text('SAFETY',style: TextStyle(fontSize: 20.0,fontFamily: 'JacquesFrancois',color: Colors.white,),)
                       ),
                       Positioned(
                           top: _height*0.07,
                           left: _width*0.12,
                       ...
                       ElevatedButton(
                         ...
                         children: [
                           ...
                           Container(
                             ...
                             height: _height*0.08,
                             decoration: BoxDecoration(
                             image: DecorationImage(image: AssetImage('assets/images/break.png'))
                             ),
                           ),
                         ...
                         child: Column(
                           children: [
                             ...
                             Container(
                               ...
                               height: _height*0.08,
                               decoration: BoxDecoration(
                                   image: DecorationImage(image: AssetImage('assets/images/battery.png'))
                               ),
                             ),
                             SizedBox(height: _height*0.01,),
                         ...
                         child: Column(
                           children: [
                             ...
                             Container(
                               ...
                               height: _height*0.08,
                               decoration: BoxDecoration(
                                   image: DecorationImage(image: AssetImage('assets/images/seat.png'))
                               ),
                             ),
                             SizedBox(height: _height*0.01,),
                         ...
                         child: Column(
                           children: [
                             ...
                             Container(
                               ...
                               height: _height*0.08,
                               decoration: BoxDecoration(
                                   image: DecorationImage(image: AssetImage('assets/images/addMore.png'))
                               ),
                             ),
